# plant_detection/serializers.py - UPDATED VERSION
...
class PlantDetectionResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'image_url', 'has_image', 'prediction', 'confidence', 
            'created_at', 'user_id', 'user_email', 'user_type'
        ]
        read_only_fields = [
            'id', 'created_at', 'user_id', 'user_email', 
            'user_type', 'image_url', 'has_image'
        ]
