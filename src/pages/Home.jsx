              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                {user.role ? (
                  <Link to={user.role === 'farmer' ? '/farmer' : '/customer'}>
                    <Button
                      size="lg"
                      className="bg-white text-primary hover:bg-white/90 shadow-large text-lg px-8 py-4 h-auto"
                    >
                      Go to Dashboard
                  ...
                  <>
                    ...
                    <Link to="/services">
                      <Button
                        variant="outline"
                        size="lg"
                        className="border-white text-primary hover:bg-white hover:text-primary text-lg px-8 py-4 h-auto"
                      >
                        Learn More
                      </Button>
                    </Link>
